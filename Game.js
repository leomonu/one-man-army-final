class Game{
    constructor(){
        ...
        this.gameOverSound = loadSound("gameOver.mp3");
        this.winSound = loadSound("winSound.mp3");
    ...
    play(){
        ...
        if(this.flag1 === 0 ){ 
            ...
            for(var q  =0;q<this.bulletGroup.length;q ++){
                for(var i = 0;i < this.wave1Group.length;i ++){ 
                    ...
                    if(this.bulletGroup.isTouching(this.wave1Group.get(i))){
            ...
            if(this.wave1Count === 5) this.flag2 = 1;
        ...
        if(this.flag2 === 1 ){
            ...
            for(var j = 0;j < this.bulletGroup.length;j ++){ 
                for(var t  =0;t<this.wave2Group.length;t++){
                if(this.bulletGroup.isTouching(this.wave2Group.get(t))){
                    this.bulletGroup.get(j).destroy();
                    this.wave2Group.get(t).destroy();
                    this.enemyCount = this.enemyCount+1;
                }
            }
            }
            if(this.wave2Count === 5) this.flag3 = 1;
        ...
        if(this.flag3 === 1 ){
            this.spawnWave3();
            for(var p = 0;p < this.bulletGroup.length;p ++){ 
                for(var s  =0;s<this.wave3Group.length;s ++){
                if(this.bulletGroup.isTouching(this.wave3Group.get(s))){
                    this.bulletGroup.get(p).destroy();
                    this.wave3Group.get(s).destroy();
                    this.enemyCount = this.enemyCount+1;
                }
            }
            }
    ...
    spawnWave2(){
        if(frameCount%70 === 0 && this.wave2Count<5){
    ...
    spawnWave3(){
        if(frameCount%70 === 0 && this.wave3Count<5){
            var enemy3 = createSprite(width+650,height/2,10,10);
